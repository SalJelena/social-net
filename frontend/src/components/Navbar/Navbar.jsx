...
function Navbar(props) {
	...
	return (
		...
		<div className='container mx-auto px-2 lg:px-0 sm:px-6 md:px-8 w-full max-w-[1370px]'>
			<nav className="relative px-4 py-4 m-4 flex justify-between items-center bg-white rounded-lg shadow dark:bg-gray-900">
				...
				{localStorage.hasOwnProperty('sm_user') ? (
					<div className='flex justify-end w-full'>
						<div className='flex gap-1 text-md ml-4'>
							<NavLink to='/'
									 className='navbar_link hidden lg:inline-block lg:ml-auto lg:mr-3 py-2 px-6 bg-primary text-white px-[14px] py-[7px] rounded-lg hover:bg-[#F8D16F] transition-colors'>Home</NavLink>
							<NavLink to='/posts'
									 className='navbar_link hidden lg:inline-block lg:ml-auto lg:mr-3 py-2 px-6 bg-primary text-white px-[14px] py-[7px] rounded-lg hover:bg-[#F8D16F] transition-colors'>Posts</NavLink>
							<NavLink to='/ads'
									 className='navbar_link hidden lg:inline-block lg:ml-auto lg:mr-3 py-2 px-6 bg-primary text-white px-[14px] py-[7px] rounded-lg hover:bg-[#F8D16F] transition-colors'>Ads</NavLink>
						</div>
						{/* profile settings */}
						<div className='flex gap-3'>
							{(user.image) ? (
								<img
									...
									src={user.image}
									alt='profile-img'
									className='w-[40px] h-[40px] object-cover rounded-full cursor-pointer hover:border hover:border-[#F8D16F] hover:border-solid transition-colors'
								/>
							) : (
								<div
									onClick={ handleDropdown }
							...
							<button type='button' className='navbar_link bg-[#F8D16F] text-white px-[14px] py-[7px] rounded-lg hover:bg-primary transition-all' onClick={handleLoggOut}>Logout</button>
